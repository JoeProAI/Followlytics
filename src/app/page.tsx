      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <div className="max-w-sm mx-auto space-y-3">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Choose Your Sign-In Method</h2>
            
            {/* X OAuth Button */}
            <button
              onClick={handleXSignIn}
              className="w-full bg-black hover:bg-gray-800 text-white px-4 py-3 rounded-lg font-medium flex items-center justify-center gap-2 transition-colors"
            >
            ...
            <button
              ...
              className="w-full bg-white hover:bg-gray-50 text-gray-900 border border-gray-300 px-4 py-3 rounded-lg font-medium flex items-center justify-center gap-2 transition-colors"
            >
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Authorize X Access</h3>
              <p className="text-sm text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Start Scanning</h3>
              <p className="text-sm text-gray-600">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          <div className="bg-white rounded-lg p-4 shadow-sm">
            ...
            <h3 className="font-semibold text-gray-900 mb-2 text-center">Track Followers</h3>
          ...
          <div className="bg-white rounded-lg p-4 shadow-sm">
            ...
            <h3 className="font-semibold text-gray-900 mb-2 text-center">Find Unfollowers</h3>
            <p className="text-sm text-gray-600 text-center">
          ...
          <div className="bg-white rounded-lg p-4 shadow-sm">
            ...
            <h3 className="font-semibold text-gray-900 mb-2 text-center">Analytics</h3>
            <p className="text-sm text-gray-600 text-center">
