...
const tiers = [
  {
    ...
    features: [
      ...
      'All export formats (JSON, CSV, MD)',
  ...
  },
  {
    ...
    tier: 'starter',
    description: 'AI-powered insights for creators',
    features: [
      '10,000 followers per month',
      '50 extractions per month',
      'All export formats',
      'AI Analysis (50 credits)',
      'Gamma Reports (10/month)',
  ...
  },
  {
    ...
    tier: 'pro',
    description: 'Complete intelligence for serious growth',
    features: [
      '50,000 followers per month',
      '200 extractions per month',
      'Unlimited AI Analysis',
      'Unlimited Gamma Reports',
      'Track 15 competitor accounts',
  ...
  },
  {
    ...
    tier: 'enterprise',
    description: 'Enterprise-grade analytics for teams',
    features: [
      '200,000 followers per month',
